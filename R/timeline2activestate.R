#' @aliases timeline2activestate
#'
#' @title Convert contexts (episodes) in non-overlapping
...
#'
#' @details This function converts a timeline-formatted dataframe with Start
#' and End time values, and Group and State columns, to an active state
#' format context data frame with a Time column and columns containing
...
timeline2activestate <- function (data, time1.var="StartTime",
